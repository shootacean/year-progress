...
var $author$project$Main$init = _Utils_Tuple2(
	A3($justinmimbs$date$Date$fromCalendarDate, 2021, $elm$time$Time$Jan, 1),
...
var $rundis$elm_bootstrap$Bootstrap$CDN$stylesheet = A3(
	...
	_List_Nil);
var $author$project$Main$thisYearLastDate = function (y) {
	return A3($justinmimbs$date$Date$fromCalendarDate, y, $elm$time$Time$Dec, 31);
};
...
var $author$project$Main$customLocale = _Utils_update(
...
var $author$project$Main$formatNumber = function (v) {
	return A2($cuducos$elm_format_number$FormatNumber$format, $author$project$Main$customLocale, v);
};
...
var $author$project$Main$viewDetailRow = F2(
	function (l, v) {
		return A2(
			$elm$html$Html$tr,
			_List_Nil,
...
var $author$project$Main$viewDetail = F2(
	function (date, diffDays) {
		var diffWeeks = diffDays / 7;
		var diffMonths = diffDays / 30.5;
		var diffHours = diffDays * 24;
		var diffMinutes = diffHours * 60;
		var diffSeconds = diffMinutes * 60;
		return A2(
			$elm$html$Html$table,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A2(
							$author$project$Main$viewDetailRow,
							'Today',
							A2($justinmimbs$date$Date$format, 'yyyy-MM-dd', date)),
							A2(
							$author$project$Main$viewDetailRow,
							'Months',
							$author$project$Main$formatNumber(diffMonths)),
							A2(
							$author$project$Main$viewDetailRow,
							'Weeks',
							$author$project$Main$formatNumber(diffWeeks)),
							A2(
							$author$project$Main$viewDetailRow,
							'Days',
							$author$project$Main$formatNumber(diffDays)),
							A2(
							$author$project$Main$viewDetailRow,
							'Hours',
							$author$project$Main$formatNumber(diffHours)),
							A2(
							$author$project$Main$viewDetailRow,
							'Minutes',
							$author$project$Main$formatNumber(diffMinutes)),
							A2(
							$author$project$Main$viewDetailRow,
							'Seconds',
							$author$project$Main$formatNumber(diffSeconds))
						]))
				]));
	});
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Development by '),
							A2(
							$elm$html$Html$a,
							_List_fromArray(
								[
									$elm$html$Html$Attributes$href('https://shootacean.com')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text('shootacean.')
								])),
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$href('https://github.com/shootacean/year-progress')
								]),
							_List_fromArray(
								[
...
var $author$project$Main$viewHeader = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Year Progress')
				]))
		]));
...
var $rundis$elm_bootstrap$Bootstrap$Progress$progressMulti = function (bars) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		A2($elm$core$List$map, $rundis$elm_bootstrap$Bootstrap$Progress$renderBar, bars));
};
...
var $author$project$Main$viewProgressBar = function (v) {
	var remain = 100 - v;
	return $rundis$elm_bootstrap$Bootstrap$Progress$progressMulti(
		_List_fromArray(
			[
				_List_fromArray(
				[
					$rundis$elm_bootstrap$Bootstrap$Progress$danger,
					$rundis$elm_bootstrap$Bootstrap$Progress$value(v),
				...
				[
					...
					$rundis$elm_bootstrap$Bootstrap$Progress$value(remain),
					$rundis$elm_bootstrap$Bootstrap$Progress$label(
					$elm$core$Debug$toString(remain))
				])
			]));
};
var $author$project$Main$view = function (date) {
	var end = $author$project$Main$thisYearLastDate(
		$justinmimbs$date$Date$year(date));
	var diffDays = A3($justinmimbs$date$Date$diff, $justinmimbs$date$Date$Days, date, end);
	var v = 100 - $elm$core$Basics$ceiling((diffDays / 365) * 100);
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Main$viewProgressBar(v),
						A2($author$project$Main$viewDetail, date, diffDays)
					])),
